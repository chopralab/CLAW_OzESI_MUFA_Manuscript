...
def analyze_lipid_peaks_with_peakfinder(df, lipid_pattern, sample_id, config=None):
    """
...
def analyze_all_lipids_for_sample(df, sample_id, config=None, lipid_patterns=None):
    """
    ...
    for pattern in lipid_patterns:
        ...
        results = analyze_lipid_peaks_with_peakfinder(df, pattern_regex, sample_id, config)
...
def visualize_lipid_ratios(all_results, sample_id):
    """
...
def main():
    ...
    for pattern in lipid_patterns:
        ...
        results = analyze_lipid_peaks_with_peakfinder(df_canola_lipids, pattern_regex, sample_id, lipid_config)
        all_results[pattern] = results
    ...
    visualize_lipid_ratios(all_results, sample_id)
