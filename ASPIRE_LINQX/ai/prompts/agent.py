# Prompt modification for human-agent interaction (does not assume defaults and asks human for clarification)
...
# Prompt modification for agent-agent interaciton (does not assume defaults and instead requests additional information in response)
...
# Modified from Langchain example chat prompt template
