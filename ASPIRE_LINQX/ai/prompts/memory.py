...
#? Interemmediate memory looks like chat memory?
#TODO: we need to write a similar prompt for the embedded memory and only summarise for specific tools that is used to access the memory
...
[
    (AgentAction(
        ...
        {{   
            ...
            "action_input": {{"question" : "What is the amount of legs a dog has?"}}
        }}
    ), 
