...
# TODO we should add some form of call validation
...
def object_to_microservice(
    ...
    '''
    # TODO when we update Langchain version, add Pydantic V2 schema compatability
    ...
    # TODO add schema to microservice here
    ...
    # Create the driver command set from all methods of the object
    # print(getmembers(object, ismethod))
    # print(getmembers(object, lambda o: ismethod(o) and getmodule(o) == getmodule(object)))
